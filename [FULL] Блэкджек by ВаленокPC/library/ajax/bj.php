...
$html_w = $html_f = '';
$color = array(5 => "74AE04", 10 => "9E9E9E", 15 => "0574C9", 20 => "DB48A2", 25 => "D8DB04", 50 => "EFA900", 100 => "DC0000", 500 => "FFC0CB", 1000 => "B0C4DE", 5000 => "ff0000", 10000 => "000000");

if (!$sql = DB()->fetch_rowset("SELECT *  FROM " . BB_BLACKJACK . " ORDER BY `bj_date` DESC")) {
