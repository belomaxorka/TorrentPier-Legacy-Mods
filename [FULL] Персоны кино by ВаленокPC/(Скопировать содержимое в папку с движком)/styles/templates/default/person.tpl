...
<tr>
	<td class="row1 vTop tCenter" width="5%">
		<div id="avatar-img" class="mrg_4 med">
            <img title="{PERS_NAME_RU} <!-- IF PERS_NAME_EN -->({PERS_NAME_EN})<!-- ENDIF -->" width="260px" height="370px" src="{PERS_IMAGES}">
		</div>
        ...
        <table class="nowrap borderless user_contacts w100">
            ...
            <tr>
                <td class="tLeft med">
                    <a href="{U_PERS_EDIT}">{L_EDIT}</a></td>
            </tr>
            <tr>
	...
	<td class="row1" valign="top" width="95%">
		...
		<table class="borderless w100">
            <tr>
                ...
                <td>{PERS_NAME_RU} <!-- IF PERS_NAME_EN --><span class="small">({PERS_NAME_EN})</span></td><!-- ENDIF -->
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><div class="wAuto">{PERS_BIOGRAPHY}</div></td>
            </tr>
            <!-- ENDIF -->
		</table>
	</td>
        ...
        <td class="td2 row2 tCenter">
            <table width="100%" class="forumline tablesorter">
                ...
                <tr class="tCenter row1 med" id="tor_{distribution.POST_ID}">
                    ...
                    <td class="tLeft">
                        <a title="{distribution.FULL_TOPIC_TITLE}" class="med" href="{distribution.U_VIEW_TOPIC}"><!-- IF distribution.TOR_FROZEN -->{distribution.TOPIC_TITLE}<!-- ELSE --><b>{distribution.TOPIC_TITLE}</b><!-- ENDIF --></a> {distribution.TOR_STATUS_ICON}
                        <!-- IF distribution.PAGINATION --><span class="topicPG">&nbsp;[{ICON_GOTOPOST}{L_GOTO_SHORT} {distribution.PAGINATION} ]</span><!-- ENDIF -->
                    </td>
                    <td>{distribution.AUTHOR}</td>
                    <td class="tCenter nowrap" style="padding: 2px 4px;">
                        <span class="seedmed" title="{L_SEEDERS}"><b>{distribution.SEEDERS}</b></span><span class="med"> | </span><span class="leechmed" title="{L_LEECHERS}"><b>{distribution.LEECHERS}</b></span>
                        <div class="spacer_2"></div>
                        <!-- IF distribution.TOR_FROZEN -->{distribution.TOR_SIZE}<!-- ELSE --><a title="{L_DL_TORRENT}" href="{DOWNLOAD_URL}{distribution.ATTACH_ID}" class="small si-dl">{distribution.TOR_SIZE}</a><!-- ENDIF -->
                    </td>
...
<table class="forumline">
    ...
    <tr>
        <td class="catBottom {PG_ROW_CLASS}">
            ...
            <p style="float: right">{PAGINATION}</p></td>
    </tr>
    <!-- ENDIF -->
</table>
<!-- ENDIF / TPL_PERS_LIST -->